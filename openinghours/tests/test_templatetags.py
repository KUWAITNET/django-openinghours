...
class TemplatetagsTestCase(OpeningHoursTestCase):
    ...
    def test_iso_day_to_weekday(self):
        with freeze_time("2016-02-22"):  # Monday
            self.assertEqual(force_str(iso_day_to_weekday(1)), u'today')
            self.assertNotEqual(force_str(iso_day_to_weekday(2)), u'today')
        with freeze_time("2016-02-23"):  # Tuesday
            self.assertNotEqual(force_str(iso_day_to_weekday(1)), u'today')
            self.assertEqual(force_str(iso_day_to_weekday(2)), u'today')
